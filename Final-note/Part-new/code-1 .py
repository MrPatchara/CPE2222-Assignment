# โปรแกรมในการรับค่าของจำนวนบรรทัด (Line) ของรูปสามเหลี่ยม (Triangle) แล้วใช้อักษร ‘*’ วาดรูปสามเหลี่ยมดังแสดงในรูปต่อไปนี้ โดยโปรแกรมจะวนซ้ำรับค่าไปเรื่อยๆ จะกว่าจะพิมพ์เลข ‘0’
