# 4 โปรแกรมในการรับค่าตัวเลขที่มีค่าตั้งแต่ 0 จนถึง 5,000 แล้วเปลี่ยนตัวเลขนั้นเป็นข้อความภาษาอังกฤษ โดยหากรับค่านอกเหนือจากตัวเลขที่มีค่าตั้งแต่ 0 จนถึง 5,000 ให้โปรแกรมหยุดการทำงาน
